...
export const Footer = (): JSX.Element => { 
    return (
        <footer className={css.footer}>
            <div className={css.shadowBorder}></div>
            <div className={css.box}>
                <div className={css.column}>
                    <h1 className={css.title}>Help</h1>
                    <ul className={css.list}>
                        <li className={css.item}>Payment</li>
                        <li className={css.item}>Delivery</li>
                        <li className={css.item}>Returns</li>
                        <li className={css.item}>Gift Card</li>
                        <li className={css.item}>Guest purchase</li>
                        <li className={css.item}>Electronic receipt</li>
                    </ul>
                </div>
                <div className={css.column}>
                    <h1 className={css.title}>Terms</h1>
                    <ul className={css.list}>
                        <li className={css.item}>Privacy policy</li>
                        <li className={css.item}>Cookie settings</li>
                        <li className={css.item}>Cookies policy</li>
                        <li className={css.item}>Site Map</li>
                        <li className={css.item}></li>
                        <li className={css.item}></li>
                    </ul>
                </div>
                <div className={css.column}>
                    <h1 className={css.title}>We are NOVA</h1>
                    <ul className={css.list}>
                        <li className={css.item}>About Nova</li>
                        <li className={css.item}>Join Life</li>
                        <li className={css.item}>Work with us</li>
                        <li className={css.item}>Press</li>
                        <li className={css.item}></li>
                        <li className={css.item}></li>
                    </ul>
                </div>
                <div className={css.info}>
                    ...
                    <div className={css.infoBox}>
                        ...
                        <p className={css.language}>Ukraine | English</p>
                    </div>
                    <div className={css.infoBox}>
                        <svg
                            className={css.img}
                        ...
                        <p className={css.number}>Call 900 456 003</p>
                        <p className={css.active}>Online</p>
                    </div>
                    <p className={css.workDays}>From Mondays to Fridays from 09:00 to 19:00</p>
                </div>
            </div>
            <p className={css.copyright}>© 2023 by NOVA. All Rights Reserved.</p>
        </footer>
    )
}
